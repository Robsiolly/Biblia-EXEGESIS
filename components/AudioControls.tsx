    ...
    <div className="glass p-3 md:p-5 rounded-2xl md:rounded-3xl flex flex-col md:flex-row items-center gap-4 md:gap-8 border border-white/10 shadow-2xl animate-in slide-in-from-top-4 duration-500 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4 md:gap-8 w-full md:w-auto justify-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            className="bg-transparent text-white/90 text-[11px] md:text-sm focus:outline-none cursor-pointer hover:text-amber-400 transition-colors font-medium outline-none"
          >
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            <optgroup label="Masculino" className="bg-[#16213e] text-amber-400/80">
              <option value="Kore" className="bg-[#16213e]">Estevão (Sóbrio)</option>
              <option value="Charon" className="bg-[#16213e]">Bento (Profundo)</option>
            </optgroup>
            <optgroup label="Feminino" className="bg-[#16213e] text-amber-400/80">
              <option value="Puck" className="bg-[#16213e]">Sara (Narrativa)</option>
      ...
      <div className="flex flex-col gap-1 w-full md:flex-1 md:min-w-[140px]">
        <div className="flex justify-between items-center">
          ...
          <span className="text-[10px] text-amber-400 font-mono font-bold tracking-tighter">{speed.toFixed(1)}x</span>
        </div>
        <input
          type="range"
          min="0.5"
